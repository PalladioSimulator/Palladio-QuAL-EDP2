...
/**
 * This class contains test cases for the DTWR distance metric.
 * 
 * @author Christian Schaf
 */
public class TestDTWR {	
	private final DTWR dtwr = new DTWR();
	...
	public void sampleDataTest() {
		...
		Amount<?> result = dtwr.calculateDistance(tds1.getDataStream(), tds2.getDataStream());
		/* 
		 * The R implementation gives the result 5.0 with the sample data of this class. 
		 * The self-implemented DTW gives the result 3.0, as also seen in the linked gif.
		 */
		assertEquals(5.0, result.getEstimatedValue(), Utility.DELTA);
	}
}
